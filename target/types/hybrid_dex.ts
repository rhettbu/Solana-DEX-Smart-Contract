...
export type HybridDex = {
  "address": "G12WABos41DU4ic2RLea5qwCfSyvB83XdKz9CMdiJLUW",
  "metadata": {
    "name": "hybridDex",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "errors": [
    ...
    {
      "code": 6009,
      "name": "incorrectMakerAddress",
      "msg": "Order maker address not matched with passed maker"
    },
    {
      "code": 6010,
      "name": "partialOrderAmountExceed",
